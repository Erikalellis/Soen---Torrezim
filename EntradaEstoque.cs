...
{
    /// <summary>
    /// Entrada de Estoque: escolhe um produto, informa a quantidade e registra
    /// a entrada, somando na quantidade disponível do produto.
    /// </summary>
    public partial class EntradaEstoque : Form
    {
        ...
        private void CriarInterface()
        {
            ...
            lblQtdAtual = new Label { AutoSize = true, Location = new Point(510, 63), ForeColor = Color.DarkBlue };
        ...
        private void Registrar()
        {
            ...
            try
            {
                ProdutoDAO.Movimentar(p.Id, "entrada", qtd, txtDocumento.Text.Trim());
                CarregarProdutos();
                CarregarMovimentacoes();
                txtQuantidade.Text = "1";
                txtDocumento.Clear();
                MessageBox.Show("Entrada registrada!", "SOEN", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
