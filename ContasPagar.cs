...
namespace Soen___Torrezim
{
    ...
    public partial class ContasPagar : BaseForm
    {
        ...
        private void CriarInterface()
        {
            ...
            btnEditar = UIHelpers.CreateButton("Editar Sel.", new Point(292, 90), new Size(110, 28));
            btnEditar.Click += (s, e) => CarregarParaEdicao();
            btnCancelarEdicao = UIHelpers.CreateButton("Cancelar Edição", new Point(412, 90), new Size(130, 28));
            btnCancelarEdicao.Enabled = false;
            btnCancelarEdicao.Click += (s, e) => CancelarEdicao();
            btnExcluir = UIHelpers.CreateButton("Excluir Sel.", new Point(552, 90), new Size(110, 28));
            ...
            Controls.AddRange(new Control[] { l1, txtDescricao, l2, txtFornecedor, l3, dtpVencimento, l4, txtValor,
                l5, txtParcelas, btnAdicionar, btnPagar, btnEditar, btnCancelarEdicao, btnExcluir, grid });
        }
        ...
        private void SalvarConta()
        {
            ...
            {
                // divide o total em parcelas iguais com o mesmo dia do mês
        ...
        private void CarregarParaEdicao()
        {
            ...
            foreach (var c in lista)
            {
                ...
                txtFornecedor.Text = c.Fornecedor;
                DateTime d;
